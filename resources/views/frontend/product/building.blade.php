...
@section('title')
    Partnership Building Maintanance & Cleaning
@endsection
        ...
        <div class="container h-100 p-5">
            <div class="row align-items-center h-100">
                <div class="col-12 text-center text-white">
                    ...
                    <img src="{{ asset('storage/logo/light/cleaning.png') }}"
                        alt="Partnership Building Maintanance & Cleaning" class="w-50">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="s-line-hr-top" style="min-height: 100svh;background-color: #fff">
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <p class="lead fw-normal">Partnership Building Maintenance & Cleaning menawarkan layanan pembersihan dan
        ...
        <div class="container py-3 marketing">
            ...
            <div class="row featurette align-items-center">
                ...
                <div class="col-md-5 order-md-1">
                    <img src="{{ asset('assets/img/photo/building/2.webp') }}" alt="Partnerhsip"
                        class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        height="500">
                </div>
            </div>
